...
<head>
  ...
  <title>Danh mục - Admin G15</title>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td data-label="id">AD</td>
                <td data-label="name">Áo Dài</td>
                <td data-label="content">Danh mục áo dài gồm 10 sản phẩm</td>

                <td data-label="Hidden">
                  <button class="button " data-target="sample-modal-2" type="button">
                    <span class="icon"> <input class="icon" type="checkbox" id="1" name="1" value="1"></span>
                  </button>
