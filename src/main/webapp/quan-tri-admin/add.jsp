...
<section class="is-hero-bar">
  ...
  <section class="section main-section">
      ...
      <div class="card-content">
        <form method="get">
            ...
            <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="text" placeholder="Tên sản phẩm">
                  <span class="icon left"><i class="mdi mdi-table"></i></span>
                </div>
              </div>
              <div class="field">
                <div class="control icons-left icons-right">
                  <input class="input" type="text" placeholder="Mã sản phẩm" >
              ...
              <div class="field">
                <div class="field addons">
                  <div class="control expanded">
                    <input class="input" type="tel" placeholder="Số lượng sản phẩm">
                  </div>
                  <div class="control expanded">
          ...
          <div class="field">
            ...
            <div class="control">
              <input class="input" type="text" placeholder="Giá sản phẩm (VND)">
            </div>
            <br>
            <div class="control">
              <input class="input" type="text" placeholder="Giá khuyến mãi (VND)">
            </div>
          </div>
    ...
    <div class="card">
      ...
      <div class="card-content">
        <div class="field">
          <label class="label">Chi tiết danh mục</label>
          <div class="field-body">
            <div class="field grouped multiline">
              <div class="control">
                <label class="radio">
                  ...
                  <span class="control-label">Sắp bán</span>
                </label>
              </div>
              <div class="control">
                <label class="radio">
                  ...
                  <span class="check"></span>
                  <span class="control-label">Đang bán</span>
                </label>
              </div>
              <div class="control">
                <label class="radio">
                  <input type="radio" name="sample-radio" value="two">
                  <span class="check"></span>
                  <span class="control-label">Hết bán</span>
                </label>
              </div>
              <div class="control">
                <label class="radio">
                  <input type="radio" name="sample-radio" value="two">
                  <span class="check"></span>
                  <span class="control-label">Khóa bán</span>
                </label>
              </div>
            </div>
          </div>
