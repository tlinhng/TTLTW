            ...
            <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="text" placeholder="Mã code">
              ...
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="text" placeholder="Phần trăm giảm">
                  <!-- <span class="icon left"><i class="mdi mdi-table"></i></span> -->
                </div>
              </div>
                    ...
                    <div class="field grouped multiline">
                      <div class="control">
                        <label class="radio">
                          ...
                          <span class="control-label">Đã dùng</span>
                        </label>
                      </div>
                      <div class="control">
                        <label class="radio">
                          ...
                          <span class="check"></span>
                          <span class="control-label">Chưa dùng</span>
                        </label>
                      </div>
                    </div>
                  </div>
