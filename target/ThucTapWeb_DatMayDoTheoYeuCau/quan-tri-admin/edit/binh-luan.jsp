            ...
            <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="text" placeholder="Rebecca Bauch">
                  <!-- <span class="icon left"><i class="mdi mdi-table"></i></span> -->
                </div>
              </div>
              <div class="field">
                <div class="control icons-left icons-right">
                  <input class="input" type="text" placeholder="Daugherty-Daniel" >
                  
                </div>
              </div>
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="text" placeholder="123@gmail.com">
                  <!-- <span class="icon left"><i class="mdi mdi-table"></i></span> -->
                </div>
              </div>
              <div class="field">
                <div class="control icons-left icons-right">
                  <input class="input" type="text" placeholder="0956777662" >
                  
                </div>
              </div>
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="text" placeholder="TPHCM">
                  <!-- <span class="icon left"><i class="mdi mdi-table"></i></span> -->
                </div>
              </div>
